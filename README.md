...
- `images/` — PNG images for each room (room1-brain.png through room10-patterns.png). **Include this folder when pushing to GitHub** so the images load on your live site.
